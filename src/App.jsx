...
//       <h2 className="mb-6 text-xl">Align your Face Inside the Circle</h2>

//       <div className="relative bg-zinc-900 p-6 rounded-3xl shadow-xl">
//         {/* FLASH */}
//         <div
...
import GalleryCapture from "./GalleryCapture";
...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-black text-white flex flex-col items-center justify-center p-6">
      <h1 className="text-2xl mb-6">Profile Photo Creator</h1>
